...
# Board
from community.apps.boards.api.views import BoardGroupViewSet, BoardViewSet, BoardGroupAdminViewSet, \
    BoardAdminViewSet, BoardsViewSet, CommunityBoardGroupsViewSet, CommunityBoardGroupsWriteViewSet

# Post
from community.apps.posts.api.views import PostViewSet, PostsViewSet, BoardPostsViewSet, CommunityPostsViewSet, \
    CommunityPostsAdminViewSet
