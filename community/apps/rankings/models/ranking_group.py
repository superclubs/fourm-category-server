...
# Manager
from community.apps.rankings.models.manager.ranking_group_manager import RankingGroupManager
...
class RankingGroup(Model):
    ...
    ranking_type = models.CharField(_('Ranking Type'), choices=RANKING_TYPE_CHOICES, max_length=100, null=True, blank=True)
