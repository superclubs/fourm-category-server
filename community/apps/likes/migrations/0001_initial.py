    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Comment Dislike',
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.DateTimeField(blank=True, null=True, verbose_name='Deleted')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('type', models.CharField(choices=[('LIKE', 'LIKE'), ('FUN', 'FUN'), ('HEALING', 'HEALING'), ('LEGEND', 'LEGEND'), ('USEFUL', 'USEFUL'), ('EMPATHY', 'EMPATHY'), ('DEVIL', 'DEVIL')], default='LIKE', max_length=100, verbose_name='Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Post Dislike',
                'ordering': ['-created'],
            },
            bases=(community.bases.models.UpdateMixin, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('LIKE', 'LIKE'), ('FUN', 'FUN'), ('HEALING', 'HEALING'), ('LEGEND', 'LEGEND'), ('USEFUL', 'USEFUL'), ('EMPATHY', 'EMPATHY'), ('DEVIL', 'DEVIL')], max_length=100, null=True, verbose_name='Type')),
                ('community', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_likes', to='communities.community', verbose_name='Community')),
            ],
            options={
