...
class PostLike(Model):
    ...
    profile = models.ForeignKey('profiles.Profile', verbose_name=_('Profile'), on_delete=models.CASCADE,
...
class CommentLike(Model):
    comment = models.ForeignKey('comments.Comment', verbose_name=_('Comment'), on_delete=models.CASCADE,
