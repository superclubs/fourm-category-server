...
# Mixins
from community.apps.boards.models.mixins import (
...
# Modules
from community.modules.choices import (
    BOARD_GROUP_TYPE_CHOICES,
    BOARD_TYPE_CHOICES,
    VIEW_MODE_CHOICES,
)
...
class BoardGroup(Model):
    community = models.ForeignKey(
        "communities.Community", verbose_name=_("Club"), on_delete=models.CASCADE, related_name="board_groups"
    )
...
class Board(BoardPostModelMixin, BoardCommentModelMixin, BoardPermissionMixin, Model):
    community = models.ForeignKey(
        "communities.Community", verbose_name=_("Community"), on_delete=models.CASCADE, related_name="boards", null=True
    )
    community_title = models.CharField(_("Community Title"), max_length=60, null=True, blank=True)
