...
class CommunityPointModelMixin(models.Model):
    ...
    def update_community_point(self):
        self.point = self.bookmark_point + self.post_point + self.comment_point + \
                     self.posts_like_point + self.posts_dislike_point + \
                     self.comments_like_point + self.comments_dislike_point + self.posts_visit_point
