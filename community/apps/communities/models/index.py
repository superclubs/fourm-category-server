...
# Mixins
from community.apps.communities.models.mixins import (
...
class Community(
    ...
    parent_community = models.ForeignKey(
        "self",
        verbose_name=_("Parent Community"),
    ...
    user = models.ForeignKey(
        "users.User", verbose_name=_("Master"), on_delete=models.SET_NULL, null=True, related_name="communities"
    )
