...
class ProfilePointModelMixin(models.Model):
    ...
    def update_profile_point(self):
        self.point = self.post_point + self.posts_like_point + self.posts_dislike_point + self.community_visit_point + \
                     self.comment_point + self.comments_like_point + self.comments_dislike_point
