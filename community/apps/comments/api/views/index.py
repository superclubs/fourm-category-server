...
class CommentViewSet(
    ...
    @swagger_auto_schema(**swagger_decorator(tag="04. 댓글", id="댓글 삭제", description="", response={204: "no content"}))
    ...
    def comment_comment(self, request, pk=None):
        ...
        if serializer.is_valid(raise_exception=True):
            instance = serializer.save(
                ...
                community=parent_comment.community,
                user=user,
                profile=profile,
