...
class ReportChoice(Model):
    community = models.ForeignKey(
        "communities.Community", verbose_name=_("Community"), on_delete=models.CASCADE, related_name="report_choices"
    )
    user = models.ForeignKey(
        "users.User", verbose_name=_("User"), on_delete=models.SET_NULL, null=True, related_name="report_choices"
    )
...
class ReportGroup(ReportGroupReportModelMixin, Model):
    community = models.ForeignKey(
        "communities.Community", verbose_name=_("Community"), on_delete=models.CASCADE, related_name="report_groups"
    )

    # Contents
    post = models.ForeignKey(
        "posts.Post", verbose_name=_("Post"), on_delete=models.SET_NULL, null=True, related_name="report_groups"
    )
    ...
    profile = models.ForeignKey(
        "profiles.Profile",
        verbose_name=_("Reported User Profile"),
        on_delete=models.SET_NULL,
        null=True,
        related_name="report_groups",
    )
...
class Report(Model):
    ...
    report_group = models.ForeignKey(
        "ReportGroup", verbose_name=_("Report Group"), on_delete=models.SET_NULL, null=True, related_name="reports"
    )

    # Reporter
    user = models.ForeignKey(
        "users.User", verbose_name=_("Report User"), on_delete=models.SET_NULL, null=True, related_name="reports"
    )
    profile = models.ForeignKey(
        "profiles.Profile",
        verbose_name=_("Report User Profile"),
        on_delete=models.SET_NULL,
        null=True,
    ...
    # Contents
    post = models.ForeignKey(
        "posts.Post", verbose_name=_("Post"), on_delete=models.SET_NULL, null=True, related_name="reports"
    )
    comment = models.ForeignKey(
        "comments.Comment", verbose_name=_("Comment"), on_delete=models.SET_NULL, null=True, related_name="reports"
    )
    contents = models.CharField(_("Contents"), max_length=1000, null=True, blank=True)
